...
from .commands import api_users, base_stations, config_cmd, contract_infos, coverages, device_types, devices, groups, users
...
cli.add_command(contract_infos.contract_infos)
cli.add_command(coverages.coverages)
